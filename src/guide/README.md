...
В первом случае, команда очищает слой и показывает изображение, во втором — просто показывает изображение поверх других.
Приведём пример:
...
А здесь была использована команда `show`, которая лишь сменила фон на другой, не затрагивая другие изображения.
