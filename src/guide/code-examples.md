...
- `text_history_screen` - Экран прочитанного текста.
...
init python:
    ...
    def my_mod_screen_act():  # Функция замены экранов из оригинала на собственные.
        ...
        }  # Вставьте ваш путь до курсора в вашего мода, если его нет - закомментируйте строку.
...
```renpy
action [(Function(my_mod_screens_diact)), MainMenu(confirm=False)]
```
...
Затём создаём словари, что будут содержать в себе иллюстрации и фоны, потом заполняем с помощью цикла нашу галерею.
